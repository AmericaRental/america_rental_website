  ...
  return (
    <Product
      ...
      description={[
        ...
        <br/>,
        <br/>,
        "A ", <strong>quantidade de limpezas</strong>," é determinada pela ", <strong>quantidade médida de usuários</strong>,", sendo o programa mínimo composto por 1 limpeza por semana, não podendo ser menos pois esta é a validade do produto químico usado.",
        <br/>,
        <br/>,
        "Na ",<strong>manutenção</strong>," é realizada a reposição dos insumos, sucção do tanque e a limpeza interna da cabine."
      ]}
      imgs={[img2,img3,img4]}
      specs={
        [
